...
==================
  ...
  * Support reviews in `case` blocks ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
==================
  ...
  * Support text bodies of tags that begin with `//` rather than treating them as reviews ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
==================
  ...
  * Stop parsing reviews and remove support for conditional reviews ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
===================
  ...
  * HTML reviews are pretty printed better (thanks to [@eddiemonge](https://github.com/eddiemonge))
...
==================
  ...
  * Added: allow leading space for conditional reviews
...
==================
  ...
  * Fixed conditional reviews documentation. Closes #245
...
==================
  ...
  * Added conditional-review support. Closes #146
  * Added block review support
  * Added rss example
  * Added `:stylus` filter
...
==================
  ...
  * Added support for arbitrary indentation for single-line reviews. Closes #71
...
==================
  ...
  * Added unbuffered review support. Closes #62
  * Added hyphen support for tag names, ex: "fb:foo-bar"
  * Fixed bug with single quotes in reviews. Closes #61
  * Fixed review whitespace issue, previously padding. Closes #55

0.3.0 / 2010-08-04
==================

  * Added single line review support. Closes #25
