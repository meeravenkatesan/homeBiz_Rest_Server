 ...
 * collection.find({}).review('add a review')                   // Add a review to the query, allowing to correlate queries
...
/**
 * Add a review to the cursor query allowing for tracking the review in the log.
 * @method
 * @param {string} value The review attached to this query.
 * @throws {MongoError}
 * @return {Cursor}
 */
Cursor.prototype.review = function(value) {
  if(this.s.state == Cursor.CLOSED || this.s.state == Cursor.OPEN || this.isDead()) throw MongoError.create({message: "Cursor is closed", driver:true});
  this.s.cmd.review = value;
  return this;
}

define.classMethod('review', {callback: false, promise:false, returns: [Cursor]});
