...
mpath.get('reviews.1.title', obj) // 'exciting!'
```
...
mpath.get('reviews.title', obj) // ['funny', 'exciting!']
```
...
mpath.get('reviews.title', obj, function (val) {
  return 'funny' == val
    ? 'amusing'
    : val;
});
...
mpath.set('reviews.1.title', 'hilarious', obj)
console.log(obj.reviews[1].title) // 'hilarious'
```
...
mpath.set('reviews.title', ['hilarious', 'fruity'], obj);
...
mpath.set('reviews.title', ['hilarious', 'fruity'], obj, function (val) {
  return val.length;
});
...
mpath.get('reviews.0.title', obj, '_doc')            // 'great!'
mpath.set('reviews.0.title', 'nov 3rd', obj, '_doc')
mpath.get('reviews.0.title', obj, '_doc')            // 'nov 3rd'
mpath.get('reviews.0.title', obj)                    // 'exciting'
```
