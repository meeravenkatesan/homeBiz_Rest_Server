...
var reviewsProcessor = require('./text/reviews-processor');
...
var CleanCSS = module.exports = function CleanCSS(options) {
  ...
  this.options = {
    ...
    keepSpecialreviews: 'keepSpecialreviews' in options ? options.keepSpecialreviews : '*',
...
function minify(context, data) {
  ...
  var reviewsProcessor = new reviewsProcessor(context, options.keepSpecialreviews, options.keepBreaks, options.sourceMap);
  ...
  function restoreEscapes(data, prefixContent) {
    ...
    return reviewsProcessor.restore(data);
  }
