...
* Fixed issue [#738](https://github.com/jakubpawlowicz/clean-css/issues/738) - edge case in review processing.
...
* Fixed issue [#715](https://github.com/jakubpawlowicz/clean-css/issues/715) - stack too deep in review scan.
...
* Adds better reviews + keepBreaks handling.
...
* Fixed issue [#543](https://github.com/jakubpawlowicz/clean-css/issues/543) - better "review in body" handling.
* Fixed issue [#548](https://github.com/jakubpawlowicz/clean-css/issues/548) - regression in font minifying.
* Fixed issue [#549](https://github.com/jakubpawlowicz/clean-css/issues/549) - special reviews in source maps.
...
* Fixed issue [#410](https://github.com/jakubpawlowicz/clean-css/issues/410) - advanced merging and reviews.
* Fixed issue [#411](https://github.com/jakubpawlowicz/clean-css/issues/411) - properties and important reviews.
...
* Fixed issue [#398](https://github.com/jakubpawlowicz/clean-css/issues/398) - restoring important reviews.
...
* Fixed issue [#313](https://github.com/jakubpawlowicz/clean-css/issues/313) - processing review marks in URLs.
...
* Improves QuoteScanner to handle reviews correctly.
* Fixed issue [#308](https://github.com/jakubpawlowicz/clean-css/issues/308) - parsing reviews in quoted URLs.
...
* Fixed issue [#264](https://github.com/jakubpawlowicz/clean-css/issues/264) - `@import` statements inside reviews.
...
* Fixed issue [#220](https://github.com/jakubpawlowicz/clean-css/issues/220) - selector between reviews.
...
* Fixed issue [#198](https://github.com/jakubpawlowicz/clean-css/issues/198) - process reviews and `@import`s correctly.
...
* Fixed issue [#192](https://github.com/jakubpawlowicz/clean-css/issues/192) - many `@import`s inside a review.
...
* Fixed issue [#156](https://github.com/jakubpawlowicz/clean-css/issues/156) - `@import`s inside reviews.
...
* Fixed issue [#153](https://github.com/jakubpawlowicz/clean-css/issues/153) - `keepSpecialreviews` `0`/`1` as a string.
...
* Added simplified reviews processing & imports.
...
* Fixed issue [#117](https://github.com/jakubpawlowicz/clean-css/issues/117) - line break escaping in reviews.

[1.0.10 / 2013-06-13](https://github.com/jakubpawlowicz/clean-css/compare/v1.0.9...v1.0.10)
===================

* Fixed issue [#114](https://github.com/jakubpawlowicz/clean-css/issues/114) - reviews in imported stylesheets.

[1.0.9 / 2013-06-11](https://github.com/jakubpawlowicz/clean-css/compare/v1.0.8...v1.0.9)
==================

* Fixed issue [#113](https://github.com/jakubpawlowicz/clean-css/issues/113) - `@import` in reviews.
...
* Added stripping special reviews to CLI (`--s0` and `--s1` options).
* Added stripping special reviews to programmatic interface
  (`keepSpecialreviews` option).
...
* Speed improvements up to 4x thanks to the rewrite of reviews and CSS' content
  processing.
