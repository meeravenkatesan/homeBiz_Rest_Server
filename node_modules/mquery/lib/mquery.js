 ...
 * - [review](http://www.mongodb.org/display/DOCS/Advanced+Queries#AdvancedQueries-%24review) *
 ...
 * ####Example
 *
 *     query.$where('this.reviews.length > 10 || this.name.length > 5')
 *
 *     query.$where(function () {
 *       return this.reviews.length > 10 || this.name.length > 5;
 *     })
 *
 ...
 * ####Example
 *
 *     query.elemMatch('review', { author: 'autobot', votes: {$gte: 5}})
 *
 *     query.where('review').elemMatch({ author: 'autobot', votes: {$gte: 5}})
 *
 *     query.elemMatch('review', function (elem) {
 *       elem.where('author').equals('autobot');
 *       elem.where('votes').gte(5);
 *     })
 *
 *     query.where('review').elemMatch(function (elem) {
 ...
 * ####Example
 *
 *     query.slice('reviews', 5)
 *     query.slice('reviews', -5)
 *     query.slice('reviews', [10, 5])
 *     query.where('reviews').slice(5)
 *     query.where('reviews').slice([-10, 5])
 *
 * @param {String} [path]
 ...
 */
/**
 * Specifies the `review` option.
 *
 * ####Example
 *
 *     query.review('login query')
 *
 * ####Note
 *
 * Cannot be used with `distinct()`
 ...
 * @memberOf Query
 * @param {Number} val
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries#AdvancedQueries-%24review
 * @api public
 */

/*!
 * limit, skip, maxScan, batchSize, review
 *
 * Sets these associated options.
 *
 *     query.review('feed query');
 */

;['limit', 'skip', 'maxScan', 'batchSize', 'review'].forEach(function (method) {
 ...
 *   options: <review, fields, readPreference, etc>,
