...
describe('mquery', function(){
  ...
  describe('elemMatch', function(){
    ...
    describe('with 1 argument', function(){
      ...
      describe('that is an object', function(){
        ...
        it('works', function(){
          var m = mquery().where('review').elemMatch({ author: 'joe', votes: {$gte: 3 }});
          assert.deepEqual({ review: { $elemMatch: { author: 'joe', votes: {$gte: 3}}}}, m._conditions);
        })
      })
      describe('that is a function', function(){
        ...
        it('works', function(){
          var m = mquery().where('review').elemMatch(function (query) {
    ...
    describe('with 2 arguments', function(){
      describe('and the 2nd is an object', function(){
        it('works', function(){
          var m = mquery().elemMatch('review', { author: 'joe', votes: {$gte: 3 }});
          assert.deepEqual({ review: { $elemMatch: { author: 'joe', votes: {$gte: 3}}}}, m._conditions);
        })
      })
      describe('and the 2nd is a function', function(){
        it('works', function(){
          var m = mquery().elemMatch('review', function (query) {
            query.where({ author: 'joe', votes: {$gte: 3 }})
          });
          assert.deepEqual({ review: { $elemMatch: { author: 'joe', votes: {$gte: 3}}}}, m._conditions);
        })
  ...
  var negated = {
    ...
    , review: {distinct: false, count: false}
  };
  ...
  describe('count', function(){
    ...
    describe('validates its option', function(){
      ...
      it('review', function(done){
        assert.throws(function(){
          var m = mquery().review('mquery').count();
        }, /review cannot be used with count/);
        done();
      })
  ...
  describe('distinct', function(){
    ...
    describe('validates its option', function(){
      ...
      it('review', function(done){
        assert.throws(function(){
          var m = mquery().review('mquery').distinct();
        }, /review cannot be used with distinct/);
        done();
      })
  ...
  function validateFindAndModifyOptions (method) {
    describe('validates its option', function(){
      ...
      it('review', function(done){
        assert.throws(function(){
          var m = mquery().review('mquery')[method]();
        }, new RegExp('review cannot be used with ' + method));
        done();
      })
    })
  }
